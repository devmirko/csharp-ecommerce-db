    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_OrderProduct", x => new { x.OrderProductOrderId, x.ProductOrderProductId });
                    table.ForeignKey(
                        name: "FK_OrderProduct_Orders_OrderProductOrderId",
                        column: x => x.OrderProductOrderId,
                        principalTable: "Orders",
                        principalColumn: "OrderId",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_OrderProduct_Products_ProductOrderProductId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_OrderProduct_ProductOrderProductId",
                table: "OrderProduct",
